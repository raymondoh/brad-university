 ...
 *
 * This is the template that displays all single program posts by default.
 * It is used when a visitor requests a single program post.
 *
 * @package WordPress
...
// Debugging code
echo '<!-- single-program.php is being used -->';
?>
<main>
    <?php
    ...
    <div class="container container--narrow page-section">
        ...
        $relatedProfessors = new WP_Query(array(
            'posts_per_page' => -1,
            'post_type' => 'professor', // Ensure this matches your CPT slug
        ...
        if ($relatedProfessors->have_posts()) {
            ...
            echo '<h2 class="headline headline--medium">Related Professors</h2>';
        ...
        $relatedEvents = new WP_Query(array(
            'posts_per_page' => 2,
            'post_type' => 'event', // Ensure this matches your CPT slug
            'meta_key' => 'event_date',
